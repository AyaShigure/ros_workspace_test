...
if __name__ == '__main__':
    ...
    #
    #    result1 = display1(message1)
    #    result2 = display2(message2)

        rospy.init_node('status_disp')
        result1 = rospy.Subscriber('keyboard_input',Motor_control,display1)
        result2 = rospy.Subscriber('SR04_buzz_Hz',Hz,display2)
